...
const CONTROL_NAV_ITEM: NavItem = {
  path: "/control",
  label: "JARVIS",
  icon: Zap,
};
          ...
          >
            ...
            >
              ...
              >
                ...
                <Typography className="font-bold text-[1.125rem] leading-[0.95] tracking-[0.12em] text-midground uppercase">
                  JARVIS
                </Typography>
              </div>
            ...
            <nav
              className={cn(
                ...
                isDesktopCollapsed && "lg:[scrollbar-width:none] lg:[&::-webkit-scrollbar]:hidden",
              )}
              aria-label={t.app.navigation}
            >
              <div
                className={cn(
                  "mx-2 mb-2 rounded-xl border border-current/15 bg-current/[0.03] p-1",
                  "shadow-[0_0_32px_color-mix(in_srgb,var(--midground-base)_8%,transparent)]",
                  isDesktopCollapsed && "lg:mx-0 lg:mt-2 lg:w-full lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none",
                )}
              >
                <ul className={cn("flex flex-col", isDesktopCollapsed && "lg:items-center")}>
                  <SidebarNavLink
                    closeMobile={closeMobile}
                    collapsed={isDesktopCollapsed}
                    item={CONTROL_NAV_ITEM}
                    key={CONTROL_NAV_ITEM.path}
                    t={t}
          ...
          <PageHeaderProvider pluginTabs={pluginTabMeta}>
            ...
            >
              ...
              <div
                className={cn(
                  "w-full min-w-0",
                  !isChatRoute && !isControlRoute &&
                    "pb-[calc(2rem+env(safe-area-inset-bottom,0px))] lg:pb-8",
                  (isDocsRoute || isChatRoute || isControlRoute) &&
...
function SidebarNavLink({
  ...
  const isControlLink = path === "/control";
  ...
  return (
    <li
      className={cn(collapsed && "flex w-full justify-center", "first:pt-0")}
      ...
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            ...
            collapsed && "lg:w-full lg:justify-center lg:gap-0 lg:px-0",
            isControlLink && collapsed && "lg:m-0 lg:h-9 lg:w-9 lg:justify-center lg:rounded-full lg:border lg:border-cyan-300/35 lg:bg-cyan-300/10 lg:px-0 lg:text-cyan-100",
            isControlLink && !collapsed && "rounded-xl border border-cyan-300/20 bg-cyan-300/[0.04] text-cyan-100",
            isActive
              ? "text-midground"
        ...
        style={{
          clipPath: isControlLink ? "none" : "var(--component-tab-clip-path)",
        }}
      >
        {({ isActive }) => (
          <>
            {isControlLink && collapsed ? (
              <Icon className="relative mx-auto h-4 w-4 shrink-0 text-cyan-100" />
            ) : (
              <Icon className={cn("h-3.5 w-3.5 shrink-0", isControlLink && "text-cyan-100")} />
            )}
            ...
            <span
              aria-hidden
              className={cn(
                "absolute inset-y-0.5 left-1.5 right-1.5 bg-midground opacity-0 pointer-events-none transition-opacity duration-200 group-hover/nav:opacity-5",
                isControlLink && collapsed && "hidden",
              )}
            />

            {isActive && !(isControlLink && collapsed) && (
              <span
                aria-hidden
  ...
  return (
    ...
    <ConfirmDialog
      ...
      description={
        ...
        "This restarts the JARVIS gateway process. Connected channels and active sessions will reconnect afterward."
      }
